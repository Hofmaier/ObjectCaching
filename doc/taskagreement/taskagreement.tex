...
\begin{itemize}
\item Können Instanzvariablen eines Objekts durch mehrere Clients modifiziert werden, so muss bei einer Schreiboperation garantiert werden, dass der Client, welcher die Schreiboperation ausführen will, dies basierend auf dem aktuell im Objekt gespeicherten Wert tut. Wird dies nicht geprüft, kann es dazu führen, dass Änderungen, welche ein anderer Client zwischenzeitlich gemacht hat, verloren gehen.
\end{itemize}
