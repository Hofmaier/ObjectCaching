...
Die genauen Messerwerte, mit Durch\-schnitts\-wer\-ten und Ver\-gleichen zwischen den verschiedenen Systemen sind am Schluss dieser Arbeit zu finden. 
...
\begin{enumerate}
\item Aus dem Configuration Objekt wird die Server IP, der RMI Port und der Name, unter dem der Framework Server registriert ist, ausgelesen. Aus diesen Informationen wird eine neue RMI Verbindung zum Framework Server erzeugt.
