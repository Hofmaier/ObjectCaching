...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.55]{images_MessErgebnisse/getBalance_RMI.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.7]{images_MessErgebnisse/getBalance_03ms.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.7]{images_MessErgebnisse/incrementAndReadRMI.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.55]{images_MessErgebnisse/incrementAndReadCache.png}
\end{center}
...
Dass das Cache-System bei diesem Testcase so gut ska\-liert war eigentlich zu erwarten. Mit einem leichten An\-s\-tieg der Mess\-werte wurde gerechnet, doch auch dieser blieb ansich aus. Mit dem Pro\-blem der Zeit\-messung in Java im Hinter\-kopf, kann man sagen, dass \texttt{setBalance()}-Aufrufe immer gleich schnell sind, egal, ob zwei oder acht Clients über den neuen Betrag des Balance-Wertes benachrichtigt werden müssen.
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.7]{images_MessErgebnisse/incrementRMISetBalance.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.7]{images_MessErgebnisse/incrementRMIKonfliktzahl.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.7]{images_MessErgebnisse/incrementRMIPureOperationTime.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.7]{images_MessErgebnisse/incrementCacheSetBalance.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.7]{images_MessErgebnisse/incrementCacheKonfliktzahl.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.8]{images_MessErgebnisse/incrementCachePureOperationTime.png}
\end{center}
\caption{Pure Operation Time, System ohne Cache(nur schreibende Zugriffe)}
\end{figure}
