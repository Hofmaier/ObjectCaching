...
Die Arbeit wurde durch Mercury motiviert, unserer Ziele sind jedoch losgelöst von diesem System, da genannten Probleme bei allen verteilten Software Systemen auftreten.
...
\begin{itemize}
\item Können Instanzvariablen eines Objekts durch mehreren Clients modifiziert werden, so muss bei einer Schreiboperation garantiert werden, dass ein Client vor der Schreiboperation den aktuellen Wert aus dem Objekt gelesen hat. Wird dies nicht geprüft kann es dazu führen das Änderungen, welche ein anderer Client zwischenzeitlich gemacht hat, verloren gehen.
\end{itemize}
