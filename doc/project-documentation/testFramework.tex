...
\item Im Konstruktor des TestClients wird der AccountService, des übergebenen ClientSystemUnderTest über die Methode "getAccountService()" geladen. 
...
\item Bei einem Shutdown durch den Server ist der TestClient ebenfalls für die ordnungsgemässe Beendigung des ClientSystemUnderTest zuständig.
\end{itemize}
